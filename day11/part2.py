...
class Monkey:
    ...
    def process_items(self):
        ...
        for old in self.items:
            ...
            worry = eval(self.operation) % common_multiple
...
if __name__ == "__main__":
    ...
    with open("puzzledata.txt") as file:
        for monkey_description in file.read().split("\n\n"):
            ...
            # build up a common multiple that can be used to
            # reduce down the worry levels as they scale up
            common_multiple *= divisible_test

            # put a monkey object in the list of monkeys
            monkeys.append(Monkey(items, operation, divisible_test, true_throw, false_throw))

    # iterate through every monkey in turn for 10,000 rounds
