...
# find the smallest file that will take the free space over 30M
space_to_free = 30_000_000 - (70_000_000 - directories[""])
smallest = 99_999_999
for key, value in directories.items():
    if value >= space_to_free and value < smallest: smallest = value
